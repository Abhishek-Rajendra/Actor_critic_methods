'''
Here we are implementing Advantage Actor Critic Algorithm
...
##################################################################
    ...
    path = environment +"/"+variant+"/" + variant + "_" + str(alpha1)+"_" +actor_info +\
        "_" +str(alpha2)+"_" +critic_info+"_"+str(gamma)
    ...
    for i in range(n_episodes):
        ...
        while not done:
            ...
            #Train Actor network
            actor.actor.fit([state, delta], actions,verbose=0)
